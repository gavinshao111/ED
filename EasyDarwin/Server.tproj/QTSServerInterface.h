...
public:
    ...
    OSRefTable* GetHLSSessionMap() {
        return fHLSMap;
    }

    OSRefTable* GetReflectorSessionMap() {
        return fReflectorSessionMap;
    }

    OSRefTable* GetRTSPReqInfoMap() {
        return fRTSPReqInfoMap;
    }
